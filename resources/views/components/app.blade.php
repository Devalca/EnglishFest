...
<head>
    ...
    <title>{{ $homeContent->title ?? 'English Fest' }}</title>
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>{{ config('app.name', 'English Fest 2024') }}</title>
...
<body class="font-sans antialiased">
        ...
        <div class="mx-auto max-w-screen-xl">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0 w-full lg:w-96">
                    <div class="p-4 bg-white border border-gray-200 rounded-lg shadow">
                        <a href="#" class="flex items-center">
                            ...
                            <span
                                class="text-[#1a9df7] ml-3 self-center lg:text-2xl text-sm font-semibold whitespace-nowrap ">{{ $homeContent->title }}</span>
                        </a>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 class="mb-6 text-sm font-semibold uppercase ">SUMBER DAYA</h2>
                        <ul class="dark:text-gray-400">
                            {{-- <li class="mb-4">
                                <a href="#" class="hover:underline">Post list</a>
                            </li> --}}
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="dark:text-gray-400">
                            @foreach ($homeContent->cs as $cs)
                                <li class="mb-4">
                                    <a href="{{ $cs['wa_link'] }}" target="_blank" rel="noopener noreferrer"
                                        class="hover:underline">
                                        {{ $cs['wa_number'] }} ({{ $cs['name'] }})
                                    </a>
                                </li>
                            @endforeach
                        </ul>
            ...
            <div class="sm:flex sm:items-center sm:justify-between text-center">
                <span class="text-sm">© 2023 <a href="#" class="hover:underline">{{ $homeContent->title }}</a>.
                    All Rights Reserved.
                </span>
    ...
    <div class="fixed bottom-5 right-5 z-10">
        <a href="{{ $homeContent->whatsapp_link }}" target="_blank" rel="noopener noreferrer"
